...
import { useScreenVariants as useScreenVariantsttEIqUceCq63 } from "./PlasmicGlobalVariant__Screen"; // plasmic-import: TtEIqUceCq63/globalVariant
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic.module.css"; // plasmic-import: uU7CEgvaAv2Njj8eHgdudp/projectcss
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: 9F1QHSltpjNS/css
...
function PlasmicProjectHeader__RenderFunc(props) {
  ...
  const globalVariants = ensureGlobalVariants({
    screen: useScreenVariantsttEIqUceCq63()
  });
  return (
    <Stack__
      as={"section"}
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__ltmXh)}>
        <div className={classNames(projectcss.all, sty.column__vuCJ)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__oovZf)}>
          <div className={classNames(projectcss.all, sty.columns__kKoI8)}>
            <div className={classNames(projectcss.all, sty.column__kf2Kq)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___4Fua4)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__tfIs9)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__bnRrB)}>
                {renderPlasmicSlot({
